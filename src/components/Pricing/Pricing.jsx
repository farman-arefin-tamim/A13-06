...
const Pricing = () => {
  return (
   <div>
      ...
      <div className="card w-96 bg-linear-to-r from-[#422ce7] to-[#4c3bd3] shadow-sm text-white relative">
        <div className="badge badge-warning rounded-full absolute -top-3 left-1/2 -translate-x-1/2">Most Popular</div>
        <div className="card-body">
          <div className="flex justify-between">
          ...
          <div className="mt-6">
            <button className="btn bg-white text-[#422ce7] btn-block rounded-full">Start Pro Trial</button>
          </div>
        </div>
      </div>
      <div className="card w-96 bg-base-200 shadow-sm">
